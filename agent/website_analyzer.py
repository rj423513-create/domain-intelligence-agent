...
def get_whois_info(domain):
    try:
        ...
        return {"Registrar": "N/A", "Creation_Date": "N/A", "Expiration_Date": "N/A", "Name_Servers": "N/A", "Emails": "N/A"}
...
def get_builtwith_info(domain):
    if BUILTWITH_API_KEY and BUILTWITH_API_KEY != "your_key_here":
        try:
    ...
    try:
        ...
        if resp:
            ...
            techs = [t.get_text(strip=True) for t in soup.select(".techLink, a")[:10]]
            return {"Tech_Stack": ", ".join(techs)[:1000] or "N/A"}
    except:
        pass
